...
from nautilus_trader.adapters.coinbase.common.schemas.market import CoinbaseDepth
from nautilus_trader.test_kit.providers import TestInstrumentProvider


pytestmark = pytest.mark.skip(reason="Repair order book parsing")

ETHUSDT = TestInstrumentProvider.ethusdt_coinbase()


class TestCoinbaseHttpParsing:
    def test_parse_book_snapshot(self):
        ...
        # Act
        decoder = msgspec.json.Decoder(CoinbaseDepth)
