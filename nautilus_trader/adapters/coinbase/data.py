...
from nautilus_trader.adapters.coinbase.data import CoinbaseCommonDataClient
...
from nautilus_trader.adapters.coinbase.schemas.market import CoinbaseOrderBookPartialDepthMsg
from nautilus_trader.adapters.coinbase.schemas.market import CoinbaseTradeMsg
...
class CoinbaseDataClient(CoinbaseCommonDataClient):
    """
    ...
    def __init__(
        ...
        # HTTP API
        # self._spot_http_market = CoinbaseMarketHttpAPI(client, account_type)
        self._spot_http_market = CoinbaseMarketHttpAPI(client)


        # Spot enum parser
        self._spot_enum_parser = CoinbaseEnumParser()
        ...
        self._decoder_spot_trade = msgspec.json.Decoder(CoinbaseTradeMsg)
        self._decoder_spot_order_book_partial_depth = msgspec.json.Decoder(
            CoinbaseOrderBookPartialDepthMsg,
        )
