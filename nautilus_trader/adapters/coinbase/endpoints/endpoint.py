...
from nautilus_trader.adapters.coinbase.common.enums import CoinbaseEndpointType
...
class CoinbaseHttpEndpoint:
    def __init__(
        ...
        endpoint_type: CoinbaseEndpointType,
        url_path: str,
    ) -> None:
        self.client = client
        ...
        self._method_request: dict[CoinbaseEndpointType, Any] = {
            CoinbaseEndpointType.NONE: self.client.send_request,
            CoinbaseEndpointType.MARKET: self.client.send_request,
            CoinbaseEndpointType.ACCOUNT: self.client.sign_request,
            CoinbaseEndpointType.TRADE: self.client.sign_request,
        }
